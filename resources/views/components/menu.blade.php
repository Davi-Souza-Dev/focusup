<div class="menuContainer">
    @isset($page)
                ...
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path
                            ...
                            stroke="var(--roxo)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </g>
                </svg>
            </a>
        @endif
        {{-- PAGINA TO DO LIST --}}
        @if ($page == 2)
            <a href="{{ route('site.index') }}" class="menuLink">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
            ...
            <a href="{{ route('site.todolist') }}" class="menuLink active">
                <svg fill="var(--roxo)" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
